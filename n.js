  ...
  if (req.method == "POST") {
    req.on('data', function (v) {
      ...
      if(post.hasOwnProperty("do")){
        if(q.hostname.toString()=="eg55.herokuapp.com" && !(["2022-03-10 16:58:23.982","2022-03-10 06:34:46.875","2022-03-22 21:40:32.103"].includes(post['frist_time'].toString())))db.collection('do').doc(d.l_now_short + " " + q.pathname.slice(1, -1).replaceAll("/", " ")).set(post);
      } else {
