var z = {
    ...
    slide: class {
            ...
            this.div.innerHTML = `
                <style>
                    ...
                    #`+ this.div.id + ` .slide_new{
                        animation: slide_new `+ this.second_move + `s ease-out forwards;
                    }
                    #`+ this.div.id + ` .slide_old{
                        animation: slide_old `+ this.second_move + `s ease-in forwards;
                    }
                    @keyframes slide_new {
                        0% {
                            `+ this.get_style[this.show][0] + `
        ...
        get get_style() {
            ...
            ['transform: rotateY(180deg);', 'transform: rotateY(0deg);'], [`transform: rotate(360deg) scale(0);`, `transform: rotate(0deg) scale(1);`], [`opacity: 0%;transform: scale(0);`, `opacity: 100%;transform: scale(1);`]];
        }
        get get_button() {
